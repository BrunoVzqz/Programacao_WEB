    ...
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signup">
        ...
        <div class="mb-6">
          ...
          <input type="nome" v-model="nome" class="input" id="nome">
        </div>

        <div class="mb-6">
          <label for="sobrenome" class="label">Sobrenome</label>
          <input type="sobrenome" v-model="sobrenome" class="input" id="sobrenome">
        </div>

        <div class="mb-6">
          <label for="email" class="label">E-mail Address</label>
          <input type="date" v-model="data_nascimento" class="input" id="data_nascimento">
        </div>
        ...
        <div class="mb-6">
          <label for="password_confirmation" class="label">Comfirmar Senha</label>
